...
export default function Comment({ id }) {
  ...
  useEffect(() => {
    ...
    onSnapshot(docRef, (snapshot) => {
      const commentsData = snapshot.data()?.comments; // Use optional chaining to avoid undefined
      setComments(commentsData || []); // Initialize to an empty array if commentsData is undefined
    });
  }, [id]);
